	           ...
	           PlaylistDialog.Callback
{
	...
	public void onSlideFullyExpanded(boolean expanded) {
		...
		final int[] slide_hidden = {MENU_SHOW_QUEUE, MENU_SORT, MENU_DELETE, MENU_OPEN_FOLDER, MENU_ENQUEUE_ALBUM, MENU_ENQUEUE_ARTIST, MENU_ENQUEUE_GENRE, MENU_ADD_TO_PLAYLIST, MENU_SHARE};
