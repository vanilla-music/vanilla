...
class PlayCountsHelper {
	 ...
	 */
	static void countSong(Context context, Song song, boolean played) {
	 ...
	 */
	static ArrayList<Long> getTopSongs(Context context, int limit) {
		ArrayList<Long> payload = new ArrayList<>();
